...
def add_columns(intubation_extubation, unable):

    # unable_intu_extu의 hadm_id만 필터링
    intubation_extubation = intubation_extubation[intubation_extubation.hadm_id.isin(unable.hadm_id.unique())]
    intubation_df = [intubation_extubation['subject_id','hadm_id','stay_id','intubationtime']]
    extubation_df = [intubation_extubation['subject_id','hadm_id','stay_id','extubationtime','extubationcause']]
